...
function preload() {
  // Question pool
  sound1 = loadSound('assets/Eno_BitDepth_4-bit.mp3');
  sound2 = loadSound('assets/Eno_BitDepth_5-bit.mp3');
  sound3 = loadSound('assets/Eno_BitDepth_8-bit.mp3');
  sound4 = loadSound('assets/Hoff_BitDepth_4-bit.mp3');
  sound5 = loadSound('assets/Hoff_BitDepth_5-bit.mp3');
  sound6 = loadSound('assets/Hoff_BitDepth_8-bit.mp3');
  // Originals
...
function setup(){  
  ...
  // Subtitle
  textSize(28);
  text("4-bit, 5-bit, 8-bit", width/2, height/9 + 40);
...
function chooseSound() {
  ...
  if (choice === 0) { player = sound1; fileName = "4-bit"; }
  else if (choice === 1) { player = sound2; fileName = "5-bit"; }
  else if (choice === 2) { player = sound3; fileName = "8-bit"; }
  else if (choice === 3) { player = sound4; fileName = "4-bit"; }
  else if (choice === 4) { player = sound5; fileName = "5-bit"; }
  else if (choice === 5) { player = sound6; fileName = "8-bit"; }
}
